            ...
            <div id="bag" class="border border-light mt-1 ms-5">
                <ul v-for="item in  items" :key="item.id">
                    <li class="d-flex justify-content-between bg-white my-3">
                        ...
                        <div class="px-5 my-auto border border-dark"><h5>{{ item.title }}</h5></div>
                        <div class="px-5 my-auto border border-dark"><p>{{ item.price }}</p></div>
                        <div class="px-5 my-auto border border-dark"><p>1</p></div>
                        <div class="px-5 my-auto border border-dark me-4"><p>100$</p></div>
